<?php
  ...
  function storeAdminData() {
    ...
    if($con) {
      ...
      $query = "INSERT INTO admin_credentials (PHARMACY_NAME, ADDRESS, EMAIL, CONTACT_NUMBER, USERNAME, PASSWORD) VALUES('$pharmacy_name', '$address', '$email', '$contact_number', '$username', '$password')";
      $result = mysqli_query($con, $query);
