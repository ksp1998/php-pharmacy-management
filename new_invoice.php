...
<html lang="en" dir="ltr">
  <head>
    ...
    <script type="text/javascript" src="js/add_new_invoice.js"></script>
        ...
        <div class="row">
          ...
          <div class="row col col-md-12">
            <div class="col col-md-3 form-group">
              ...
              <input id="customers_name" type="text" class="form-control" placeholder="Name" name="customers_name" onkeyup="showSuggestions(this.value, 'customer');">
            ...
            <div class="col col-md-2 form-group">
              ...
              <input type="date" class="datepicker form-control hasDatepicker" name="invoice_date" value='<?php echo date('Y-m-d'); ?>' onblur="checkDate(this.value, 'date_error');">
          ...
          <div class="row col col-md-12">
            <div class="row col col-md-12 font-weight-bold">
              ...
              <div class="col col-md-1">Batch ID</div>
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-2 form-group float-right">
              ...
              <input type="text" class="form-control" name="total_discount" disabled>
            </div>
            <div class="col col-md-2 form-group float-right">
              <label class="font-weight-bold" for="">Total Tax :</label>
              <input type="text" class="form-control" name="total_tax" disabled>
            </div>
            <div class="col col-md-2 form-group float-right">
          ...
          <div class="row col col-md-12">
            <div class="col col-md-8 form-group"></div>
            <div class="col col-md-2 form-group float-right">
