        ...
        <div class="card-body">
          <form name="login-form" class="login-form" action="home.php" method="post" onsubmit="return validateCredentials();">
            <div class="logo">
        			...
        			<h1 class="logo-caption font-weight-bolder">
                <?php
                  ...
                  if($con) {
                    ...
                    if($row == null) {
                      header('Location:http://localhost/Pharmacy-Management/index.html');
                    }
                    $name = $row['PHARMACY_NAME'];
                    $flag = true;
                    for($i = 0; $i < strlen($name); $i++) {
                      if($flag) {
                        echo "<span class='tweak'>".$name[$i]."</span>";
                        $flag = false;
                      }
                      else if($name[$i] == " ") {
                        $flag = true;
                ...
                ?>
        			...
        			<h1 class="logo-caption" style="transform: translateY(-10px);"><span class="tweak">L</span>ogin</h1>
        		</div> <!-- logo class -->
